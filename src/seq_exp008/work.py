...
PARAMS = {
    "model": {
        ...
        "params": {
            ...
            "encoder_dropout_list": [0.25] * 16,  # len == encoder_num_blocks
            "encoder_d_model_list": [1024] * 16,  # Transformer # len == encoder_num_blocks
            "encoder_nhead_list": [8] * 16,  # Transformer # len == encoder_num_blocks
