...
PARAMS = {
    "model": {
        ...
        "head": {
            "type": "AttentionHead",  # {SimpleHead, MultiSampleDropoutHead, AttentionHead, MeanMaxPoolingHead, LSTMHead, GRUHead, CNNHead}
            "params": {
                # "dropout": 0.10,  # SimpleHead, MultiSampleDropoutHead, LSTMHead, GRUHead
