...
PARAMS = {
    "model": {
        ...
        "head": {
            "type": "CNNHead",  # {SimpleHead, MultiSampleDropoutHead, MeanMaxPoolingHead, LSTMHead, GRUHead, CNNHead}
            "params": {
                # "dropout": 0.0,  # SimpleHead, MultiSampleDropoutHead, LSTMHead, GRUHead
